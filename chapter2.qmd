...
Oczywiście! Oto poprawiona i sprawdzona wersja Twojego materiału w języku angielskim, w formacie `callout-note`, gotowa do użycia w Quarto (pisana w RStudio). Skopiuj ten kod do swojego pliku `.qmd` i dostosuj ewentualnie stylowanie do swoich preferencji.
