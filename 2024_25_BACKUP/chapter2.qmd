...
1.  **Proportions of values DO NOT hold**: \[ \frac{F_1}{F_2} = \frac{\frac{9}{5}C_1 + 32}{\frac{9}{5}C_2 + 32} \neq \frac{C_1}{C_2} \]

2.  **Proportions of differences hold**: \[ \frac{F_1 - F_2}{F_3 - F_4} = \frac{\frac{9}{5}(C_1 - C_2)}{\frac{9}{5}(C_3 - C_4)} = \frac{C_1 - C_2}{C_3 - C_4} \]
...
1.  **Collecting raw scores:** People take a test and receive a number of correct answers (e.g., 45 out of 60 questions)
2.  **Ordering:** All raw scores are arranged from worst to best
3.  **Assigning ranks:** Each score is assigned a position in the ranking
4.  **Transformation to IQ scale:** Ranks are mathematically transformed so that the mean equals 100 and standard deviation equals 15
